...
public class Config {
  ...
  private static final ConfigValue<List<? extends String>> BLOCK_CONVERSIONS;
  ...
  static {
    ...
    BLOCK_CONVERSIONS = builder.comment("Convert blocks caught in an explosion instead of putting them back or dropping them as they were, so a structure degrades a step per blast.",
                    ...
                    "Source is a block id (minecraft:stone) or a block tag with a leading # (#minecraft:logs). On 1.20.1 the ore dictionary is the forge: tag namespace, so #forge:ores/iron is an oredict rule.",
            ...
            .defineListAllowEmpty("BlockConversions", List.of(), s -> s instanceof String);
    builder.pop();
